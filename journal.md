...
Now to customize my PCB, I decided to go with a topographic design using contour lines, I used a Canva element, and I imported it into EasyEDA.
First, I stretched it out on the back side of the PCB, and used silk screen as my texture. I then added my name and my website on the back as well.
I also created a solid layer on the back so that the led on the front can sort of shine through the PCB, and create a cool effect. 
<img width="943" height="590" alt="image" src="https://github.com/user-attachments/assets/54517bb3-8acc-46d4-b38d-e001cc856e9d" />
